...
# Generated on: Wed Sep 23 17:11:23 IST 2026 (Wed Sep 23 11:41:23 UTC 2026)
...
set logfile fv/coprocessor/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/coprocessor -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/home/admin/eda/centos8/redhat_8/GENUS211/tools.lnx86"
set CDN_SYNTH_ROOT      "/home/admin/eda/centos8/redhat_8/GENUS211/tools.lnx86"
set env(CW_DIR) "/home/admin/eda/centos8/redhat_8/GENUS211/tools.lnx86/lib/chipware"
set CW_DIR      "/home/admin/eda/centos8/redhat_8/GENUS211/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /home/admin/eda/centos8/redhat_8/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/home/admin/eda/centos8/redhat_8/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/home/admin/eda/centos8/redhat_8/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/home/admin/eda/centos8/redhat_8/GENUS211/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/home/admin/eda/centos8/redhat_8/GENUS211/tools.lnx86/lib/chipware/sim"
}
...
read_library -liberty -both \
    /home/harshit/Desktop/rtltogds6/synth/.testing_pluto/PositCoprocessor_UART/gds/genus_workflow/../lib/sky130_fd_sc_hd__tt_025C_1v80.lib
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  ../../rtl/posit_primitives.sv ../../rtl/posit_decoder.sv ../../rtl/posit_encoder.sv ../../rtl/posit_addsub.sv ../../rtl/posit_muldiv.sv ../../rtl/posit_to_float.sv ../../rtl/float_to_posit.sv ../../rtl/posit_arithmetic.sv ../../rtl/uart_head.sv ../../rtl/coprocessor.sv
elaborate_design -golden -root {coprocessor} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/coprocessor/fv_map.v.gz
elaborate_design -revised -root {coprocessor}
...
#add_name_alias fv/coprocessor/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.coprocessor.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.coprocessor.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.coprocessor.rtl.fv_map.rpt
