...
# Created by Genus(TM) Synthesis Solution 21.14-s082_1 on Wed Sep 23 21:05:18 IST 2026
...
# BEGIN MSV SECTION
# END MSV SECTION
define_clock -name clk -domain domain_1 -period 740741.0 -divide_period 100 -rise 0 -divide_rise 1 -fall 1 -divide_fall 2 -remove -design design:coprocessor port:coprocessor/clk
...
external_delay -accumulate -input {740.7 740.7 740.7 740.7} -clock clock:coprocessor/clk -name in_del port:coprocessor/rst
external_delay -accumulate -input {740.7 740.7 740.7 740.7} -clock clock:coprocessor/clk -name in_del_1_1 port:coprocessor/rx
external_delay -accumulate -output {740.7 740.7 740.7 740.7} -clock clock:coprocessor/clk -name ou_del port:coprocessor/tx
...
set_db -quiet inst:coprocessor/alu_inst/g1842996 .seq_dup_name_count 1
...
## Written on 21:05:19 23-Sep 2026
#############################################################
#####   Flow Definitions   ##################################
...
if {[is_attribute flow_metrics_snapshot_uuid -obj_type root]} {set_db flow_metrics_snapshot_uuid 1af5d291-f0bf-4922-80b0-f4d034118828}
