...
# BEGIN MSV SECTION
# END MSV SECTION
define_clock -name clk -domain domain_1 -period 393701.0 -divide_period 50 -rise 0 -divide_rise 1 -fall 1 -divide_fall 2 -remove -design design:coprocessor port:coprocessor/clk
...
external_delay -accumulate -input {787.4 787.4 787.4 787.4} -clock clock:coprocessor/clk -name in_del port:coprocessor/rst
external_delay -accumulate -input {787.4 787.4 787.4 787.4} -clock clock:coprocessor/clk -name in_del_1_1 port:coprocessor/rx
external_delay -accumulate -output {787.4 787.4 787.4 787.4} -clock clock:coprocessor/clk -name ou_del port:coprocessor/tx
...
## Written on 21:23:17 23-Sep 2026
#############################################################
#####   Flow Definitions   ##################################
...
if {[is_attribute flow_metrics_snapshot_uuid -obj_type root]} {set_db flow_metrics_snapshot_uuid a4869e2a-a541-41c0-aebf-9100d50a8453}
