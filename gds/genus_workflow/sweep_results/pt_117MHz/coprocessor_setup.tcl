...
# Created by Genus(TM) Synthesis Solution 21.14-s082_1 on Wed Sep 23 21:20:08 IST 2026
...
# BEGIN MSV SECTION
# END MSV SECTION
define_clock -name clk -domain domain_1 -period 854701.0 -divide_period 100 -rise 0 -divide_rise 1 -fall 1 -divide_fall 2 -remove -design design:coprocessor port:coprocessor/clk
...
external_delay -accumulate -input {854.7 854.7 854.7 854.7} -clock clock:coprocessor/clk -name in_del port:coprocessor/rst
external_delay -accumulate -input {854.7 854.7 854.7 854.7} -clock clock:coprocessor/clk -name in_del_1_1 port:coprocessor/rx
external_delay -accumulate -output {854.7 854.7 854.7 854.7} -clock clock:coprocessor/clk -name ou_del port:coprocessor/tx
...
set_db -quiet {pin:coprocessor/uart_inst_uart_tx_inst_bit_count_reg[1]/Q_N} .original_name {uart_inst/uart_tx_inst/bit_count[1]/q}
...
## Written on 21:20:08 23-Sep 2026
#############################################################
#####   Flow Definitions   ##################################
...
if {[is_attribute flow_metrics_snapshot_uuid -obj_type root]} {set_db flow_metrics_snapshot_uuid 2290db13-bcd5-4938-92c4-40166ea21ee7}
