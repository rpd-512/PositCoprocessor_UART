...
set_db -quiet flow_metrics_snapshot_uuid 3905924e-05a6-40a3-aa3a-85740a98697a
...
# BEGIN MSV SECTION
# END MSV SECTION
define_clock -name clk -domain domain_1 -period 100000.0 -divide_period 1 -rise 0 -divide_rise 1 -fall 1 -divide_fall 2 -remove -design design:coprocessor port:coprocessor/clk
...
external_delay -accumulate -input {10000.0 10000.0 10000.0 10000.0} -clock clock:coprocessor/clk -name in_del port:coprocessor/rst
external_delay -accumulate -input {10000.0 10000.0 10000.0 10000.0} -clock clock:coprocessor/clk -name in_del_1_1 port:coprocessor/rx
external_delay -accumulate -output {10000.0 10000.0 10000.0 10000.0} -clock clock:coprocessor/clk -name ou_del port:coprocessor/tx
...
set_db -quiet {pin:coprocessor/uart_inst_uart_rx_inst_bit_count_reg[1]/Q_N} .original_name {uart_inst/uart_rx_inst/bit_count[1]/q}
...
set_db -quiet {pin:coprocessor/uart_inst_uart_tx_inst_state_reg[1]/Q_N} .original_name {uart_inst/uart_tx_inst/state[1]/q}
...
## Written on 19:55:21 23-Sep 2026
#############################################################
#####   Flow Definitions   ##################################
...
if {[is_attribute flow_metrics_snapshot_uuid -obj_type root]} {set_db flow_metrics_snapshot_uuid 3905924e-05a6-40a3-aa3a-85740a98697a}
