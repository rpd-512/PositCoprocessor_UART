...
getVersion
set init_verilog ./runB/pt/coprocessor_netlist.v
set init_top_cell coprocessor
set init_lef_file {../lib/sky130_fd_sc_hd_innovus.tlef ../lib/sky130_fd_sc_hd.lef}
set init_mmmc_file ./runB/mmmc.tcl
init_design
floorPlan -d 330 325 10 10 10 10
place_opt_design
saveDesign ./runB/place.enc
ccopt_design
saveDesign ./runB/cts.enc
routeDesign
saveDesign ./runB/route_pre.enc
report_timing -path_type full_clock -late -max_paths 10 > ./$RUN/timing_setup_preopt.rpt
verify_drc -report ./runB/drc_preopt.rpt
setAnalysisMode -analysisType onChipVariation -cppr both
optDesign -postRoute -setup
saveDesign ./runB/route.enc
verify_drc -report ./runB/drc.rpt
...
report_area > ./runB/area.rpt
report_power > ./runB/power.rpt
summaryReport -noHtml -outfile ./runB/summary.rpt
